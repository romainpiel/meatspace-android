...
/**
 * A {@link android.graphics.drawable.Drawable} which can be used to hold GIF images, especially animations.
...
public class GifDrawable extends Drawable implements Animatable
{
	 ...
	 * @throws java.io.IOException if opening
	...
	/**
	 * See {@link android.graphics.drawable.Drawable#getOpacity()}
	 * @return always {@link android.graphics.PixelFormat#TRANSPARENT}
	 */
	@Override
	 ...
	 *  
	 * @return current error or {@link pl.droidsonroids.gif.GifError#NO_ERROR} if there was no error
	 */
