...
public class PreferencesHelper {
    ...
    private static final String KEY_PREFS_IS_FRONT_CAMERA = "is_front_camera";
    ...
    public boolean isFrontCamera(boolean defaultValue) {
        return sharedPrefs.getBoolean(KEY_PREFS_IS_FRONT_CAMERA, defaultValue);
    }

    public void saveIsFrontCamera(boolean isFrontCamera) {
        prefsEditor.putBoolean(KEY_PREFS_IS_FRONT_CAMERA, isFrontCamera);
        prefsEditor.apply();
    }
